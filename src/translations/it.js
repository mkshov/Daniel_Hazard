const itTranslations = {
  ...
  ourStoryChild2:
    "Ha iniziato il suo viaggio nel 1979. Daniel Hazard si sforza di portare prodotti di alta qualità al mercato dell'abbigliamento maschile e le persone che indossano un abito o un cappotto si sentono sicure e confortevoli.",
  ...
  aboutUs0: "CHI SIAMO?",
  aboutUs1:
    "Utilizziamo le tecnologie più moderne nella produzione. L'intero processo produttivo è sotto la costante supervisione di professionisti.",
  aboutUs2:
    "La fabbrica di abiti da uomo classici collezioni di prodotti più volte all'anno. Offriamo una vasta selezione di modelli. Se stai cercando fornitori affidabili di abbigliamento maschile, siamo felici di discutere i termini della cooperazione.",
  aboutUs3:
    "La nostra produzione di abbigliamento maschile ha tutte le moderne tecnologie per la sartoria di abiti da uomo di alta qualità. Tutti i prodotti hanno un'eccellente composizione del tessuto e sono presentati solo in tonalità reali.",
  aboutUs4: "La Nostra Azienda",
  aboutUs5: "monitora attentamente la qualità dei suoi prodotti",
  aboutUs6:
